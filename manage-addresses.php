...
<html lang="en">
    <head>
        ...
        <title>Địa Chỉ | Gundam Shop</title>
        <!-- Favicon-->
        ...
        <header class="bg-dark py-5 login-background">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">ADDRESS MANAGER</h1>
                </div>
...
<form method="post" name="address">
     ...
     <div class="row" style="color: #fff">
        ...
        <div class="col-6">
               <div class="row">
         <div class="col-9" align="center"><h5>Thêm Mới Địa Chỉ Thanh Toán</h5><br /></div>
         <hr />
     </div>
     <div class="row">
       ...
       <div class="row mt-3">
        ...
        <div class="col-6" style="color: #fff">
               <div class="row">
         <div class="col-9" align="center"><h5>Thêm Mới Địa Chỉ Giao Hàng</h5> 
            <input type="checkbox" name="adcheck" value="1"/>
            <small>Sử Dụng Địa Chỉ Thanh Toán Làm Địa Chỉ Giao Hàng</small></div>
         <hr />
     </div>
     <div class="row">
         <div class="col-3">Địa Chỉ</div>
       ...
       <div class="row mt-3">
         ...
         <div class="row mt-3">
                 <div class="col-5">&nbsp;</div>
         <div class="col-6"><input type="submit" name="submit" id="submit" class="btn-design-5" value="Thêm" required></div>
     </div>
