...
<html lang="en">
    <head>
        ...
        <title>Sản Phẩm Theo Danh Mục | Gundam Shop </title>
        <!-- Favicon-->
...
{ ?>
                ...
                <div class="text-center text-white">
                    ...
                    <p class="lead fw-normal text-white-50 mb-0">Sản Phẩm Trong Danh Mục</p>
                </div>
            <?php } ?>
            </div>
        </header>
...
?> 
                ...
                <?php } }  else{ ?>
     <h4 style="color:red">Không Tìm Thấy Sản Phẩm</h4>
<?php } ?>
                </div>
            </div>
