...
<html lang="en">
    <head>
        ...
        <title>Đổi Mật Khẩu | Gundam Shop</title>
        <!-- Favicon-->
...
<form method="post" name="chngpwd" onSubmit="return valid();" style="color: #fff;">
     <div class="row">
     ...
     <input type="password" class="form-control" id="newpass" name="newpass">
       ...
       <div class="row mt-3">
         ...
         <div class="col-6"><input type="password" class="form-control" id="cnfpass" name="cnfpass" required="required" ></div>
               ...
               <div class="row mt-3">
                 <div class="col-4">&nbsp;</div>
         <div class="col-6"><input type="submit" name="update" id="update" class="btn-design-5" value="Cập Nhật" required></div>
     </div>
 </form>
