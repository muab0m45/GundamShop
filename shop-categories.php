...
<html lang="en">
    <head>
        ...
        <title>Danh Mục | Gundam Shop</title>
        <!-- Favicon-->
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn-design-5" href="categorywise-products.php?cid=<?php echo htmlentities($row['catid']);?>">XEM</a></div>
                            </div>
                        </div>
                    </div>
                <?php } ?>
