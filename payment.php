     ...
     <div class="row">
       ...
       <div class="row mt-3">
         ...
         <div class="col-6">
            ...
            <select class="form-control" name="paymenttype" id="paymenttype" required>
                ...
                <option value="Debit/Credit Card">Thẻ Tín Dụng</option>
                <option value="Cash on Delivery">Trả Tiền Khi Nhận Hàng (COD)</option>
            </select>
         </div>
       ...
       <div class="row mt-3" id="txnno">
         ...
         <div class="col-6"><input type="text" name="txnnumber" id="txnnumber" class="form-control" maxlength="50"></div>
               ...
               <div class="row mt-3">
                 <div class="col-4">&nbsp;</div>
         <div class="col-6"><input type="submit" name="submit" id="submit" class="btn btn-primary" required>Thanh Toán</div>
     </div>
 </form>
