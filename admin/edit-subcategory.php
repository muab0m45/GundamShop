...
<html lang="en">
    <head>
        ...
        <title>Gundam Shop | Sửa Danh Mục Con</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Sửa Danh Mục Con</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Điều Khiển</a></li>
                            <li class="breadcrumb-item active">Sửa Danh Mục Con</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
...
<form  method="post">                                
<div class="row">
<div class="col-2">Danh Mục Gốc</div>
<div class="col-4">
