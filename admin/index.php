...
<html lang="en">
    <head>
        ...
        <title>Gundam Shop | Đăng Nhập Quản Trị</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Gundam Shop | Đăng Nhập Quản Trị</h3></div>
                                    <div class="card-body">
                                        <form method="post">
                              ...
                              <div class="card-footer text-center py-3">
                                        <div class="small"><a href="../index.php">Trở Về Trang Chủ</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
