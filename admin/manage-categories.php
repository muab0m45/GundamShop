...
<html lang="en">
    <head>
        ...
        <title>Gundam Shop | Quản Lý Danh Mục</title>
...
?>  
                                ...
                                <tr>
                                            ...
                                            <a href="manage-categories.php?id=<?php echo $row['catid']?>&del=delete" onClick="return confirm('Xác Nhận Xóa?')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
