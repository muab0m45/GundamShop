...
<html lang="en">
    <head>
        ...
        <title>Gundam Shop | Đổi Mật Khẩu Quản Trị</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Đổi Mật Khẩu Quản Trị</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Điều Khiển</a></li>
                            <li class="breadcrumb-item active">Đổi Mật Khẩu Quản Trị</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
     ...
     <input type="password" class="form-control" id="newpass" name="newpass" required>
       ...
       <div class="row mt-3">
         ...
         <div class="col-6"><input type="password" class="form-control" id="cnfpass" name="cnfpass" required="required" ></div>
               ...
               <div class="row mt-3">
                 <div class="col-4">&nbsp;</div>
         <div class="col-6"><input type="submit" name="update" id="update" class="btn btn-primary" value="Thay Đổi" required></div>
     </div>
 </form>
                            </div>
                        </div>
