...
<html lang="en">
    <head>
        ...
        <title>Gundam Shop | Sửa Sản Phẩm</title>
...
<div class="row">
<div class="col-2">Tên Danh Mục</div>
<div class="col-6">
...
<div class="row" style="margin-top:1%;">
<div class="col-2">Phí Giao Hàng</div>
...
<div class="col-6"><img src="productimages/<?php echo htmlentities($row['productImage2']);?>" width="250"><br />
    <a href="change-image2.php?id=<?php echo $row['pid'];?>">Thay Đổi</a>
</div>
</div>
...
<div class="col-6"><img src="productimages/<?php echo htmlentities($row['productImage3']);?>" width="250"><br />
    <a href="change-image3.php?id=<?php echo $row['pid'];?>">Thay Đổi</a>
</div>
</div>

<div class="row">
<div class="col-2"><button type="submit" name="submit" class="btn btn-primary">Cập Nhật</button></div>
</div>
