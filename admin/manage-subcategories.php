...
<html lang="en">
    <head>
        ...
        <title>Gundam Shop | Quản Lý Danh Mục Con</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Điều Khiển</a></li>
...
?>  
                                ...
                                <tr>
                                            ...
                                            <a href="manage-subcategories.php?id=<?php echo $row['subid']?>&del=delete" onClick="return confirm('Xác Nhận Xóa?')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
