...
<html lang="en">
    <head>
        ...
        <title>Gundam Shop | Thêm Sản Phẩm</title>
...
<div class="col-2">Danh Mục Con</div>
...
<div class="col-4"><input type="text"    name="productName"  placeholder="Nhập Tên Sản Phẩm" class="form-control" required>
</select>
</div>
</div>

<div class="row" style="margin-top:1%;">
<div class="col-2">Nhà Sản Xuất</div>
<div class="col-4"><input type="text"    name="productCompany"  placeholder="Nhập Tên Nhà Sản Xuất" class="form-control" required>
</select>
</div>
</div>
...
<div class="col-4"><input type="text"    name="productpricebd"  placeholder="Nhập Giá" class="form-control" required>
</select>
</div>
</div>
...
<div class="col-4"><input type="text"    name="productprice"  placeholder="Nhập Giá" class="form-control" required>
</select>
</div>
</div>

<div class="row" style="margin-top:1%;">
<div class="col-2">Mô Tả Sản Phẩm</div>
<div class="col-4"><textarea  name="productDescription"  placeholder="Nhập Mô Tả Sản Phẩm" rows="6" class="form-control"></textarea>
</div>
</div>

<div class="row" style="margin-top:1%;">
<div class="col-2">Phí Vận Chuyển</div>
<div class="col-4"><input type="text"    name="productShippingcharge"  placeholder="Nhập Phí Giao Hàng" class="form-control" required>
</select>
</div>
</div>
...
<div class="row" style="margin-top:1%;">
<div class="col-2">Ảnh Bìa Sản Phẩm</div>
<div class="col-4"><input type="file" name="productimage1" id="productimage1"  class="form-control" accept="image/*" title="Chỉ Chấp Nhận Định Dạng Ảnh" required>
</div>
</div>

<div class="row" style="margin-top:1%;">
<div class="col-2">Ảnh 1</div>
<div class="col-4"><input type="file" name="productimage2"  class="form-control" accept="image/*" title="Chỉ Chấp Nhận Định Dạng Ảnh" required>
</div>
</div>


<div class="row" style="margin-top:1%;">
<div class="col-2">Ảnh 2</div>
<div class="col-4"><input type="file" name="productimage3"  class="form-control" accept="image/*" title="Chỉ Chấp Nhận Định Dạng Ảnh" required>
</div>
</div>

<div class="row">
<div class="col-2"><button type="submit" name="submit" class="btn btn-primary">Thêm</button></div>
</div>
