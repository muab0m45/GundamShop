  	...
  	<div class="page-width">
		    <div class="video-hero--content">
                  ...
                  <section class="btn_section" name="Button Style 4">
                    <a href="#" class="btn-design-5" name="Dark Border" preview="true">
...
<strong>Trang <?php echo $page_no." của ".$total_no_of_pages; ?></strong>
</div>
...
<ul class="pagination justify-content-center my-4">
    ...
    <a <?php if($page_no > 1){ echo "href='?page_no=$previous_page'"; } ?> class="page-link">Trang Trước</a>
    </li>
...
?>
    ...
    <a <?php if($page_no < $total_no_of_pages) { echo "href='?page_no=$next_page'"; } ?> class="page-link">Trang Kế</a>
    </li>
