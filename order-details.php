...
<tr><td colspan="2"><a href="javascript:void(0);" onClick="popUpWindow('cancelorder.php?oid=<?php echo $row['orderid'];?>');" title="Cancel Order" class="btn-design-5">Hủy Đơn Hàng
</a></td></tr>
    </table>
</div>
...
<?php } ?>
    <div class="table-responsive">
        <table class="table" style="color: #fff;">
            <thead>
                <tr>
                    <th colspan="4"><h4>Danh Sách Sản Phẩm</h4></th>
                </tr>
            </thead>
            <tr>
                <thead>
...
?>
                ...
                <tr>
                    ...
                    <td>
                       <a href="product-details.php?pid=<?php echo htmlentities($pd=$row['pid']);?>" style="color: red;"><?php echo htmlentities($row['pname']);?></a></td>
<td>
                            <span><?php echo htmlentities($row['pprice']);?>đ</span>
                    </td>
                    <td><?php echo htmlentities($row['quantity']);?></td>
                     <td><?php echo htmlentities($totalamount=$row['quantity']*$row['pprice']);?>đ</td>
        
                </tr>
                <?php $grantotal+=$totalamount; } ?>
<tr>
    <th colspan="4">Tổng Số Tiền</th>
    <th colspan="2"><?php echo $grantotal;?>đ</th>
</tr>
                <?php } else{ ?>
                <tr>
                    <td style="font-size: 18px; font-weight:bold; color:red;">Lỗi Thực Hiện
