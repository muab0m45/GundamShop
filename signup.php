...
<html lang="en">
    <head>
        ...
        <title>Đăng Ký | Gundam Shop</title>
        <!-- Favicon-->
        ...
        <header class="bg-dark py-5 login-background">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    ...
                    <p class="lead fw-normal text-white-50 mb-0">Trang Đăng Ký Tài Khoản</p>
                </div>
...
<form method="post" name="signup" class="login-form--custom">
     <div class="row mt-3 row--edit">
         <div class="col-login"><input type="text" name="fullname" class="form-control" placeholder="Họ Tên" required ></div>
     </div>
       <div class="row mt-3 row--edit">
 ...
 <span id="user-email-status" style="font-size:12px;"></span>
       ...
       <div class="row mt-3 row--edit">
         <div class="col-login"><input type="text" name="contactnumber" pattern="[0-9]{12}" title="Số Điện Thoại Yêu Cầu Tối Đa 12 Số" class="form-control" placeholder="Điện Thoại" required></div>
     </div>

          <div class="row mt-3 row--edit">
         <div class="col-login"><input type="password" name="inputuserpwd" class="form-control" placeholder="Mật Khẩu" required></div>
     </div>
