...
<form method="post" name="passwordrecovery" onSubmit="return valid();" class="login-form--custom">

       <div class="row mt-3 row--edit">
         <div class="col-login"><input type="email" name="emailid" id="emailid" class="form-control" placeholder="Email"  required>
         </div>
          
     </div>

         <div class="row mt-3 row--edit">
         <div class="col-login"><input type="text" name="phoneno" id="phoneno" class="form-control" placeholder="Contact Number" required>
         </div>
          ...
          <div class="row mt-3 row--edit">
         <div class="col-login"><input type="password" name="inputPassword" id="inputPassword" class="form-control" placeholder="New Password" required></div>
     </div>

               <div class="row mt-3 row--edit">
         <div class="col-login"><input type="password" name="cinputPassword" id="cinputPassword" class="form-control" placeholder="Confirm Password" required></div>
     </div>

               <div class="">
         <div class="submit-login" style="padding: 20px;"><input type="submit" name="submit" id="submit" class="btn-design-5" value="Submit" required></div>
     </div>
 </form>
