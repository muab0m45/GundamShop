...
$query=mysqli_query($con,"delete from wishlist where id='$wid'");
 echo "<script>alert('Đã Xóa Khỏi Mục Yêu Thích');</script>";
...
<html lang="en">
    <head>
        ...
        <title>Yêu Thích | Gundam Shop</title>
        <!-- Favicon-->
...
<?php include_once('includes/header.php');?>
    ...
    <div class="table-responsive">
        <table class="table">
            <thead>
                <tr>
                    <th colspan="4" style="color: #fff;"><h4>Danh Sách Sản Phẩm</h4></th>
                </tr>
            </thead>
            <tbody>
<?php
...
?>
                ...
                <tr>
                    ...
                    <td class="col-md-6">
                        <div class="product-name"><a href="product-details.php?pid=<?php echo htmlentities($pd=$row['pid']);?>" style="color: red;"><?php echo htmlentities($row['pname']);?></a></div>
                           <span style="color: #fff;">Giá: <?php echo htmlentities($row['pprice']);?>đ</span>
                    </td>
                    <td>
                        <a href="my-wishlist.php?action=movetocart&id=<?php echo $row['wid']; ?>" class="btn-design-5">Thêm Vào Giỏ</a>
                    </td>
                    <td>
                        <a href="my-wishlist.php?del=<?php echo htmlentities($row['wid']);?>" onClick="return confirm('Chắc Chắn Xóa?')" class="btn-design-5">Xóa</a>
                    </td>
                </tr>
                <?php } } else{ ?>
                <tr>
