...
<html lang="en">
    <head>
        ...
        <title>Trang Cá Nhân | Gundam Shop</title>
        <!-- Favicon-->
...
<form method="post" name="profile" style="color: #fff;">
     <div class="row">
       ...
       <div class="row mt-3">
         ...
         <div class="col-6"><input type="text" name="contactnumber" value="<?php echo htmlentities($result['contactno']);?>" pattern="[0-9]{10}" title="10 numeric characters only" class="form-control" required></div>
               ...
               <div class="row mt-3">
                 <div class="col-4">&nbsp;</div>
         <div class="col-6"><input type="submit" name="Cập Nhật" id="update" class="btn-design-5" value="Cập Nhật" required></div>
     </div>
 </form>
